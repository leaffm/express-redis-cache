  ...
  function route () {
    ...
    domain.run(function () {
      ...
      middleware = function expressRedisCache_Middleware (req, res, next) {
        ...
        /** Wether the cache entry needs to be updated.
         *
         *  @type Boolean
         *  @description A flag to check wether the cache entry for this request needs to updated.
         *  @default false
         */

        var refreshCache = !!res.express_redis_cache_refresh;
        ...
        /**
         * Executes the request and caches the response.
         */
        ...
        // if cache entry needs to be updated,
        // then move forward to cache the request
        if (refreshCache) {
          return cacheRequest();
        }
